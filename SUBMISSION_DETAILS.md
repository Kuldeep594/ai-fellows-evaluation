...
- **Course-correct when the pipeline broke** – the AI helped brainstorm why the Interface Manager was timing out, but after trying the suggested fixes without success, I made the decision to switch to a direct API evaluation. I wrote the `send_healthcare_prompts.py` script by adapting a template the AI provided.
